...
class odds_calculator:
    ...
    def main_print(self):
        ...
        print("Probability outs : ", self.Probability(outs, len(self.__deck.cards))*100, "%")
        ...
        if len(self.__board) == 3:
            ...
            for key in outs_hands_pairs:
                print(key, " : ", self.Probability(outs_hands_pairs[key], outs_pairs)*100, "%")
    ...
    def getOuts(self):
        ...
        actual_hand_rank = get_five_card_rank_percentage(evaluate(self.__hands, self.__board))
